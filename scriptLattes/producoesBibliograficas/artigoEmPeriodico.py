...
# America. A, Optics Image Science and Vision
    ...
    def html(self, listaDeMembros):
        s = self.autores + '. <b>' + self.titulo + \
            '</b>. <font color=#330066>' + self.revista + '</font>. '
    ...
    def csv(self, nomeCompleto=""):
        ...
        if nomeCompleto == "":  # tratamento grupal
            s += str(self.ano) + "\t" + self.doi + "\t" + self.titulo + "\t" + self.revista + \
                "\t" + self.autores + "\t" + \
                str(self.qualis) + "\t" + str(self.qualissimilar)
        else:  # tratamento individual
            s += nomeCompleto + "\t" + str(self.ano) + "\t" + self.doi + "\t" + self.titulo + "\t" + \
                self.revista + "\t" + self.autores + "\t" + \
                str(self.qualis) + "\t" + (self.qualissimilar)
        return s
